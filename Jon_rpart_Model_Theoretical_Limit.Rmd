...
Does not seem promising. Tried rpart() on data with NAs omitted, and on data with NAs converted to means (not sure what that really means here). Tried messing around with cp cuttoffs. Couldn't really get the evaluation metric below 0.89.
